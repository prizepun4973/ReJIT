...
class Paths
{
	...
	static public function getStateLua(path:String, lua:String):String {
		if (FileSystem.exists(mods(path + 'scripts/' + 'states/' + lua + '.lua'))) {
			return mods(path + 'scripts/' + 'states/' + lua + '.lua');
		} else {
